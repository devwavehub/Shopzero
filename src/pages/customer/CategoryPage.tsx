  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        ...
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-heading font-bold text-gray-900 mb-4">{categoryName}</h1>
          <p className="text-gray-600">Discover amazing {categoryName.toLowerCase()} products from verified vendors</p>
        </div>
