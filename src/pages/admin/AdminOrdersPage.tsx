...
const AdminOrdersPage: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-heading font-bold text-gray-900">Order Management</h1>
        <p className="text-gray-600">Monitor and manage all orders across the marketplace</p>
      </div>
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div>
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>{selectedOrder.payment_reference || 'N/A'}</span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-4">Vendor Details</h4>
                  <div className="space-y-3 text-sm">
                    <div>
                      <span className="font-medium">Business Name:</span>
                      <p>{selectedOrder.vendor?.business_name}</p>
                    </div>
                  </div>
                </div>
              </div>
